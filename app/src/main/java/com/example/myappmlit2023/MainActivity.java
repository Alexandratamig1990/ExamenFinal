...
import com.example.myappmlit2023.ml.ModelCampusMaria;
import com.example.myappmlit2023.ml.ModelExamenFinal;
import com.example.myappmlit2023.ml.ModelExamenFinal;
...
public class MainActivity
    ...
    public void PersonalizedModel(View v){
        try {
            ...
            String[] etiquetas = {"Biblioteca", "Baños","Laboratorio Industrial", "POLIDEPORTIVO", "Laboratorio de suelos 2"
                    ,"Laboratorio de suelos 1","Laboratorio de Agroindustria","Parqueadero","Facultad CAYF","Laboratorio Acuicultura","FCI", "Centro Medico","FCIP", "Comedor"};

            ModelCampusMaria model = ModelCampusMaria.newInstance(getApplicationContext());
            TensorBuffer inputFeature0 = TensorBuffer.createFixedSize(new int[]{1, 224, 224, 3}, DataType.FLOAT32);
            inputFeature0.loadBuffer(convertirImagenATensorBuffer(mSelectedImage));

            ModelCampusMaria.Outputs outputs = model.process(inputFeature0);
